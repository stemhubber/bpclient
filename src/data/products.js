...
export const productsData = {
  ...
  export const morneProducts = [
      ...
      {
        id: 2,
        name: "Tower kota with sausage",
        price: 70,
        description: "Tower kota filled with sausage and toppings",
        image: "https://placehold.co/250x250?text=Tower+Sausage+Kota",
        isAvailable: true,
        waitingTime: "15 minutes"
      },
      {
        ...
        name: "King chow kota",
        price: 120,
        description: "Fully loaded King chow kota for big appetites",
        image: "https://placehold.co/250x250?text=King+Chow+Kota",
        isAvailable: true,
        waitingTime: "15 minutes"
      },
      {
      ...
      {
        id: 5,
        name: "Gwinya burger with chips",
        price: 35,
        description: "Gwinya burger served with chips",
        image: "https://placehold.co/250x250?text=Gwinya+Burger+&+Chips",
        isAvailable: true,
        waitingTime: "15 minutes"
      },
      {
      ...
      {
        id: 7,
        name: "Gwinya with chicken liver",
        price: 10,
        description: "Gwinya filled with spicy chicken liver",
        image: "https://placehold.co/250x250?text=Gwinya+Liver",
        isAvailable: true,
        waitingTime: "15 minutes"
      },
      {
        id: 8,
        name: "Gwinya with russian",
        price: 13,
        description: "Gwinya filled with russian sausage",
        image: "https://placehold.co/250x250?text=Gwinya+Russian",
        isAvailable: true,
        waitingTime: "15 minutes"
      },
      {
        id: 9,
        name: "Gwinya with polony & cheese",
        price: 8,
        description: "Gwinya filled with polony and cheese",
        image: "https://placehold.co/250x250?text=Gwinya+Polony+Cheese",
        isAvailable: true,
        waitingTime: "15 minutes"
      },
      {
        ...
        name: "Gwinya plain",
        price: 6,
        description: "Plain Gwinya with no fillings",
        image: "https://placehold.co/250x250?text=Gwinya+Plain",
        isAvailable: true,
        waitingTime: "15 minutes"
      },
      {
      ...
      {
        id: 12,
        name: "Two quarter chicken with chips",
        price: 85,
        description: "Double quarter chicken served with chips",
        image: "https://placehold.co/250x250?text=Two+Quarter+Chicken",
        isAvailable: true,
        waitingTime: "15 minutes"
      },
      {
        id: 13,
        name: "One quarter chicken & 4 Juicy",
        price: 85,
        description: "Quarter chicken with 4 juicy wings and chips",
        image: "https://placehold.co/250x250?text=Chicken+&+Juicy+Wings",
        isAvailable: true,
        waitingTime: "15 minutes"
      },
      {
        ...
        price: 85,
        description: "6 juicy wings served with chips",
        image: "https://placehold.co/250x250?text=Wings+&+Chips",
        isAvailable: true,
        waitingTime: "15 minutes"
      },
      {
      ...
      },
      {
        ...
        name: "Small Chips",
        price: 25,
        description: "Small portion of seasoned chips",
        image: "https://placehold.co/250x250?text=Small+Chips",
        isAvailable: true,
        waitingTime: "10 minutes"
      },
      {
        ...
        name: "Medium Chips",
        price: 35,
        description: "Medium portion of seasoned chips",
        image: "https://placehold.co/250x250?text=Medium+Chips",
        isAvailable: true,
        waitingTime: "10 minutes"
      },
      {
        ...
        name: "Large Chips",
        price: 40,
        description: "Large portion of seasoned chips",
        image: "https://placehold.co/250x250?text=Large+Chips",
        isAvailable: true,
        waitingTime: "10 minutes"
      },
      {
        id: 21,
        name: "Top shayala nyakanyaka",
        price: 50,
        description: "Top shayala nyakanyaka combo meal",
        image: "https://placehold.co/250x250?text=Top+Shayala+Nyakanyaka",
        isAvailable: true,
        waitingTime: "15 minutes"
      },
      {
        id: 22,
        name: "Nyakanyaka with chicken pop",
        price: 60,
        description: "Nyakanyaka special with crispy chicken pops",
        image: "https://placehold.co/250x250?text=Nyakanyaka+Chicken+Pop",
        isAvailable: true,
        waitingTime: "15 minutes"
      }
    ];